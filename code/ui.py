...
class UI:
    ...
    def display(self, player, killed, total, state):
        ...
        counter_text = self.font.render(
            f'Enemies: {killed}/{total}',
            False,
            TEXT_COLOR)

        self.display_surface.blit(counter_text, (10, 70))
        ...
        if state == 'game_over':
            ...
            self.display_surface.blit(
                text,
                text.get_rect(center=self.display_surface.get_rect().center))
